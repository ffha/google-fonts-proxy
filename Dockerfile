...
RUN apk add gcc openssl-dev wget zlib-dev make gd-dev geoip-dev pcre2-dev git libc-dev openssl zlib pcre2 gd geoip ca-certificates brotli-dev
WORKDIR /usr/src
